...
async function generateJids(database, userList, jidCount, startTime, hours) {
    ...
    while (i <= jidCount) {
        ...
        if (config.isLoggingInfo())
            console.log("jid " + i + ": " + jidcode + " " + user.username);
        i++;
    }
}
...
async function generateUsers(database, count) {
    ...
    var userList = {
        ids: [],
        usernames: [],
        bySkill: [new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array()]
    };
    var i = 1;
    while (i <= count) {
        ...
        else if (skill < 5) { skill = 3 }
        else if (skill < 8) { skill = 4 }
        else if (skill < 21) { skill = 5 }
        else if (skill < 34) { skill = 6 }
        else if (skill < 55) { skill = 7 }
        else if (skill < 89) { skill = 8 }
        else { skill = 9 }
